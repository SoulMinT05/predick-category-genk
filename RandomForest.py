...
with open('models/model_random-forest.pkl', 'wb') as model_file:
    pickle.dump(model, model_file)

with open('vectorizers/vectorizer_random-forest.pkl', 'wb') as vectorizer_file:
    pickle.dump(vectorizer, vectorizer_file)


print("Đã lưu mô hình và vectorizer vào file model_random-forest.pkl và vectorizer_random-forest.pkl")