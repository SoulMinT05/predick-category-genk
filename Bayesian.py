...
with open('models/model_bayes.pkl', 'wb') as model_file:
    pickle.dump(model, model_file)

with open('vectorizers/vectorizer_bayes.pkl', 'wb') as vectorizer_file:
    pickle.dump(vectorizer, vectorizer_file)


print("Đã lưu mô hình và vectorizer vào file model_bayes.pkl và vectorizer_bayes.pkl")