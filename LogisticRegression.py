...
model = LogisticRegression(max_iter=1000, C=0.01, solver='lbfgs')
...
with open('models/model_logistic-regression.pkl', 'wb') as model_file:
    pickle.dump(model, model_file)

with open('vectorizers/vectorizer_logistic-regression.pkl', 'wb') as vectorizer_file:
    pickle.dump(vectorizer, vectorizer_file)


print("Đã lưu mô hình và vectorizer vào file model_logistic-regression.pkl và vectorizer_logistic-regression.pkl")